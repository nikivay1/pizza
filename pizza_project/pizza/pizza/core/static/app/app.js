...
$templateCache.put("wait.html","<h3>Ваш заказ #<span ng-bind=\"cart.order.number\"></span>готовится!</h3><div class=\"cs-timer\">–<span ng-bind=\"getDisplayTimer()\"></span>–</div>");}]);